...
import datasavingutil.menuutil.MenuDataLoader;
import datasavingutil.menuutil.MenuDummyDataLoader;
import menuutil.Menu;
import usersutil.*;

public class UserDataDummyLoader extends UserDataLoader
{

    public UserDataDummyLoader(User user)
    {
        super(user);
    }
