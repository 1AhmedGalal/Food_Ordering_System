...
{
    LinkedList<String> sites; // linked list is used as restaurants will remove and add new sites frequently
    ...
    public OnsiteRestaurant(String name, String phone, String password)
    {
        super(name, phone, password);
        sites = new LinkedList<>();
    }

    public OnsiteRestaurant(String name, String phone, String password, LinkedList<String> sites)
    {
        super(name, phone, password);
        this.sites = sites;
    }
